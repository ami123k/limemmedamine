 ...
 * @author amine
 */
public class SalonDeThe extends Etablissement{
  protected  String menu;
    ...
    public SalonDeThe(String menu, String repas_servis, int id, String nom, String adresse, int telephone, String horaire_travail, String description, int code_postal, String critere, String photo, String positon, categorie cat) {
    ...
    public String toString() {
        return super.toString()+ "SalonDeThe{" + "menu=" + menu + ", repas_servis=" + repas_servis + '}';
    }
